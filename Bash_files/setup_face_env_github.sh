...
rm -Rf /project/6003167/EECE571_2022/MaskedFaceRecognition_CNN/Github/EECE571L-MaskedFaceDetection-CNN/Code/$ENV_NAME &&
virtualenv --no-download /project/6003167/EECE571_2022/MaskedFaceRecognition_CNN/Github/EECE571L-MaskedFaceDetection-CNN/Code/$ENV_NAME &&
source /project/6003167/EECE571_2022/MaskedFaceRecognition_CNN/Github/EECE571L-MaskedFaceDetection-CNN/Code/$ENV_NAME/bin/activate &&
pip install --no-index --upgrade pip &&

pip3 install opencv-python-headless pyyaml XlsxWriter scikit-image pillow hdf5storage ninja scikit-learn onnx mxnet Cython &&
