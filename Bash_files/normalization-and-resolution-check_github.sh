...
python -u /project/6003167/EECE571_2022/MaskedFaceRecognition_CNN/Github/EECE571L-MaskedFaceDetection-CNN/Code/Feature_extractor/Data_preprocessing/Normalization_and_resolution_UnnaskedDataset.py
